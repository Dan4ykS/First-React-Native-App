...
import { Modal, View, TextInput, Keyboard, TouchableWithoutFeedback, Platform, ScrollView } from 'react-native';
      ...
      <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
        <View style={{ ...styles.view, ...styles.centerFlexWrap}}>
          ...
          <View style={styles.btnGroup}>
            ...
            <CustomButton onTab={() => changeModalVisiable(false)}>Отменить</CustomButton>
          </View>
        </View>
